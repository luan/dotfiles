...
// ── Public facade for non-sidebar callers (e.g. mru overlay) ──────────────

#[derive(Clone)]
pub(crate) struct AgentBadge {
    pub(crate) name: String,
    pub(crate) gerund: Option<String>,
    pub(crate) asking: bool,
}

#[derive(Clone, Default)]
pub(crate) struct SessionBadges {
    pub(crate) attention: bool,
    pub(crate) agents: Vec<AgentBadge>,
}

pub(crate) fn query_session_badges(sessions: &[String]) -> HashMap<String, SessionBadges> {
