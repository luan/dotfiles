...
complete -c ck -n "__fish_ck_using_subcommand task; and not __fish_seen_subcommand_from list show create edit status help" -s h -l help -d 'Print help'
complete -c ck -n "__fish_ck_using_subcommand task; and not __fish_seen_subcommand_from list show create edit status help" -f -a "list" -d 'List tasks'
complete -c ck -n "__fish_ck_using_subcommand task; and not __fish_seen_subcommand_from list show create edit status help" -f -a "show" -d 'Show task details'
complete -c ck -n "__fish_ck_using_subcommand task; and not __fish_seen_subcommand_from list show create edit status help" -f -a "create" -d 'Create a new task'
complete -c ck -n "__fish_ck_using_subcommand task; and not __fish_seen_subcommand_from list show create edit status help" -f -a "edit" -d 'Edit an existing task'
complete -c ck -n "__fish_ck_using_subcommand task; and not __fish_seen_subcommand_from list show create edit status help" -f -a "status" -d 'Update task status'
complete -c ck -n "__fish_ck_using_subcommand task; and not __fish_seen_subcommand_from list show create edit status help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c ck -n "__fish_ck_using_subcommand t; and not __fish_seen_subcommand_from list show create edit status help" -s h -l help -d 'Print help'
complete -c ck -n "__fish_ck_using_subcommand t; and not __fish_seen_subcommand_from list show create edit status help" -f -a "list" -d 'List tasks'
complete -c ck -n "__fish_ck_using_subcommand t; and not __fish_seen_subcommand_from list show create edit status help" -f -a "show" -d 'Show task details'
complete -c ck -n "__fish_ck_using_subcommand t; and not __fish_seen_subcommand_from list show create edit status help" -f -a "create" -d 'Create a new task'
complete -c ck -n "__fish_ck_using_subcommand t; and not __fish_seen_subcommand_from list show create edit status help" -f -a "edit" -d 'Edit an existing task'
complete -c ck -n "__fish_ck_using_subcommand t; and not __fish_seen_subcommand_from list show create edit status help" -f -a "status" -d 'Update task status'
complete -c ck -n "__fish_ck_using_subcommand t; and not __fish_seen_subcommand_from list show create edit status help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
