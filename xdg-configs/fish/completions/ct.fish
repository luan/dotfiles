...
complete -c ck -n "__fish_ck_needs_command" -f -a "spec" -d 'Spec file operations'
complete -c ck -n "__fish_ck_needs_command" -f -a "s" -d 'Spec file operations'
...
complete -c ck -n "__fish_ck_needs_command" -f -a "notify" -d 'Handle notification hooks'
complete -c ck -n "__fish_ck_needs_command" -f -a "n" -d 'Handle notification hooks'
...
complete -c ck -n "__fish_ck_using_subcommand plan; and not __fish_seen_subcommand_from list create read latest archive show prune help" -s h -l help -d 'Print help'
complete -c ck -n "__fish_ck_using_subcommand plan; and not __fish_seen_subcommand_from list create read latest archive show prune help" -f -a "list" -d 'List execution plans for the current project'
complete -c ck -n "__fish_ck_using_subcommand plan; and not __fish_seen_subcommand_from list create read latest archive show prune help" -f -a "create" -d 'Create a new plan file'
complete -c ck -n "__fish_ck_using_subcommand plan; and not __fish_seen_subcommand_from list create read latest archive show prune help" -f -a "read" -d 'Read plan file body or frontmatter'
complete -c ck -n "__fish_ck_using_subcommand plan; and not __fish_seen_subcommand_from list create read latest archive show prune help" -f -a "latest" -d 'Find most recently modified plan file'
complete -c ck -n "__fish_ck_using_subcommand plan; and not __fish_seen_subcommand_from list create read latest archive show prune help" -f -a "archive" -d 'Move a plan file to archive/ subfolder'
complete -c ck -n "__fish_ck_using_subcommand plan; and not __fish_seen_subcommand_from list create read latest archive show prune help" -f -a "show" -d 'Show plan content by ID'
complete -c ck -n "__fish_ck_using_subcommand plan; and not __fish_seen_subcommand_from list create read latest archive show prune help" -f -a "prune" -d 'Archive plan files older than N days'
complete -c ck -n "__fish_ck_using_subcommand plan; and not __fish_seen_subcommand_from list create read latest archive show prune help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c ck -n "__fish_ck_using_subcommand plan; and __fish_seen_subcommand_from prune" -l days -d 'Age threshold in days' -r
complete -c ck -n "__fish_ck_using_subcommand plan; and __fish_seen_subcommand_from prune" -s p -l project -d 'Filter by project path' -r
complete -c ck -n "__fish_ck_using_subcommand plan; and __fish_seen_subcommand_from prune" -l dry-run -d 'Dry run — print what would be archived'
complete -c ck -n "__fish_ck_using_subcommand plan; and __fish_seen_subcommand_from prune" -s h -l help -d 'Print help'
...
complete -c ck -n "__fish_ck_using_subcommand plan; and __fish_seen_subcommand_from help" -f -a "prune" -d 'Archive plan files older than N days'
...
complete -c ck -n "__fish_ck_using_subcommand p; and not __fish_seen_subcommand_from list create read latest archive show prune help" -s h -l help -d 'Print help'
complete -c ck -n "__fish_ck_using_subcommand p; and not __fish_seen_subcommand_from list create read latest archive show prune help" -f -a "list" -d 'List execution plans for the current project'
complete -c ck -n "__fish_ck_using_subcommand p; and not __fish_seen_subcommand_from list create read latest archive show prune help" -f -a "create" -d 'Create a new plan file'
complete -c ck -n "__fish_ck_using_subcommand p; and not __fish_seen_subcommand_from list create read latest archive show prune help" -f -a "read" -d 'Read plan file body or frontmatter'
complete -c ck -n "__fish_ck_using_subcommand p; and not __fish_seen_subcommand_from list create read latest archive show prune help" -f -a "latest" -d 'Find most recently modified plan file'
complete -c ck -n "__fish_ck_using_subcommand p; and not __fish_seen_subcommand_from list create read latest archive show prune help" -f -a "archive" -d 'Move a plan file to archive/ subfolder'
complete -c ck -n "__fish_ck_using_subcommand p; and not __fish_seen_subcommand_from list create read latest archive show prune help" -f -a "show" -d 'Show plan content by ID'
complete -c ck -n "__fish_ck_using_subcommand p; and not __fish_seen_subcommand_from list create read latest archive show prune help" -f -a "prune" -d 'Archive plan files older than N days'
complete -c ck -n "__fish_ck_using_subcommand p; and not __fish_seen_subcommand_from list create read latest archive show prune help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c ck -n "__fish_ck_using_subcommand p; and __fish_seen_subcommand_from prune" -l days -d 'Age threshold in days' -r
complete -c ck -n "__fish_ck_using_subcommand p; and __fish_seen_subcommand_from prune" -s p -l project -d 'Filter by project path' -r
complete -c ck -n "__fish_ck_using_subcommand p; and __fish_seen_subcommand_from prune" -l dry-run -d 'Dry run — print what would be archived'
complete -c ck -n "__fish_ck_using_subcommand p; and __fish_seen_subcommand_from prune" -s h -l help -d 'Print help'
...
complete -c ck -n "__fish_ck_using_subcommand p; and __fish_seen_subcommand_from help" -f -a "prune" -d 'Archive plan files older than N days'
...
complete -c ck -n "__fish_ck_using_subcommand spec; and not __fish_seen_subcommand_from list create read latest archive show prune help" -s h -l help -d 'Print help'
complete -c ck -n "__fish_ck_using_subcommand spec; and not __fish_seen_subcommand_from list create read latest archive show prune help" -f -a "list" -d 'List specs for the current project'
complete -c ck -n "__fish_ck_using_subcommand spec; and not __fish_seen_subcommand_from list create read latest archive show prune help" -f -a "create" -d 'Create a new spec file'
complete -c ck -n "__fish_ck_using_subcommand spec; and not __fish_seen_subcommand_from list create read latest archive show prune help" -f -a "read" -d 'Read spec file body or frontmatter'
complete -c ck -n "__fish_ck_using_subcommand spec; and not __fish_seen_subcommand_from list create read latest archive show prune help" -f -a "latest" -d 'Find most recently modified spec file'
complete -c ck -n "__fish_ck_using_subcommand spec; and not __fish_seen_subcommand_from list create read latest archive show prune help" -f -a "archive" -d 'Move a spec file to archive/ subfolder'
complete -c ck -n "__fish_ck_using_subcommand spec; and not __fish_seen_subcommand_from list create read latest archive show prune help" -f -a "show" -d 'Show spec content by ID'
complete -c ck -n "__fish_ck_using_subcommand spec; and not __fish_seen_subcommand_from list create read latest archive show prune help" -f -a "prune" -d 'Archive spec files older than N days'
complete -c ck -n "__fish_ck_using_subcommand spec; and not __fish_seen_subcommand_from list create read latest archive show prune help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
complete -c ck -n "__fish_ck_using_subcommand spec; and __fish_seen_subcommand_from list" -s p -l project -d 'Filter by project path' -r
complete -c ck -n "__fish_ck_using_subcommand spec; and __fish_seen_subcommand_from list" -l json -d 'Output as JSON'
complete -c ck -n "__fish_ck_using_subcommand spec; and __fish_seen_subcommand_from list" -l all -d 'Show specs from all projects'
complete -c ck -n "__fish_ck_using_subcommand spec; and __fish_seen_subcommand_from list" -l archived -d 'Show archived specs instead of active'
complete -c ck -n "__fish_ck_using_subcommand spec; and __fish_seen_subcommand_from list" -s h -l help -d 'Print help'
complete -c ck -n "__fish_ck_using_subcommand spec; and __fish_seen_subcommand_from create" -l topic -d 'Spec topic' -r
complete -c ck -n "__fish_ck_using_subcommand spec; and __fish_seen_subcommand_from create" -l project -d 'Project path' -r
complete -c ck -n "__fish_ck_using_subcommand spec; and __fish_seen_subcommand_from create" -l slug -d 'Custom slug (auto-generated if omitted)' -r
complete -c ck -n "__fish_ck_using_subcommand spec; and __fish_seen_subcommand_from create" -l prefix -d 'Filename prefix' -r
complete -c ck -n "__fish_ck_using_subcommand spec; and __fish_seen_subcommand_from create" -l body -d 'Spec body content' -r
complete -c ck -n "__fish_ck_using_subcommand spec; and __fish_seen_subcommand_from create" -s h -l help -d 'Print help'
complete -c ck -n "__fish_ck_using_subcommand spec; and __fish_seen_subcommand_from read" -l frontmatter -d 'Output frontmatter as JSON'
complete -c ck -n "__fish_ck_using_subcommand spec; and __fish_seen_subcommand_from read" -s h -l help -d 'Print help'
complete -c ck -n "__fish_ck_using_subcommand spec; and __fish_seen_subcommand_from latest" -l project -d 'Project path (defaults to git root or cwd)' -r
complete -c ck -n "__fish_ck_using_subcommand spec; and __fish_seen_subcommand_from latest" -l task-file -d 'Resolve this file directly instead of mtime heuristic' -r
complete -c ck -n "__fish_ck_using_subcommand spec; and __fish_seen_subcommand_from latest" -s h -l help -d 'Print help'
complete -c ck -n "__fish_ck_using_subcommand spec; and __fish_seen_subcommand_from archive" -s h -l help -d 'Print help'
complete -c ck -n "__fish_ck_using_subcommand spec; and __fish_seen_subcommand_from show" -s h -l help -d 'Print help'
complete -c ck -n "__fish_ck_using_subcommand spec; and __fish_seen_subcommand_from prune" -l days -d 'Age threshold in days' -r
complete -c ck -n "__fish_ck_using_subcommand spec; and __fish_seen_subcommand_from prune" -s p -l project -d 'Filter by project path' -r
complete -c ck -n "__fish_ck_using_subcommand spec; and __fish_seen_subcommand_from prune" -l dry-run -d 'Dry run — print what would be archived'
complete -c ck -n "__fish_ck_using_subcommand spec; and __fish_seen_subcommand_from prune" -s h -l help -d 'Print help'
complete -c ck -n "__fish_ck_using_subcommand spec; and __fish_seen_subcommand_from help" -f -a "list" -d 'List specs for the current project'
complete -c ck -n "__fish_ck_using_subcommand spec; and __fish_seen_subcommand_from help" -f -a "create" -d 'Create a new spec file'
complete -c ck -n "__fish_ck_using_subcommand spec; and __fish_seen_subcommand_from help" -f -a "read" -d 'Read spec file body or frontmatter'
complete -c ck -n "__fish_ck_using_subcommand spec; and __fish_seen_subcommand_from help" -f -a "latest" -d 'Find most recently modified spec file'
complete -c ck -n "__fish_ck_using_subcommand spec; and __fish_seen_subcommand_from help" -f -a "archive" -d 'Move a spec file to archive/ subfolder'
complete -c ck -n "__fish_ck_using_subcommand spec; and __fish_seen_subcommand_from help" -f -a "show" -d 'Show spec content by ID'
complete -c ck -n "__fish_ck_using_subcommand spec; and __fish_seen_subcommand_from help" -f -a "prune" -d 'Archive spec files older than N days'
complete -c ck -n "__fish_ck_using_subcommand spec; and __fish_seen_subcommand_from help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
complete -c ck -n "__fish_ck_using_subcommand s; and not __fish_seen_subcommand_from list create read latest archive show prune help" -s h -l help -d 'Print help'
complete -c ck -n "__fish_ck_using_subcommand s; and not __fish_seen_subcommand_from list create read latest archive show prune help" -f -a "list" -d 'List specs for the current project'
complete -c ck -n "__fish_ck_using_subcommand s; and not __fish_seen_subcommand_from list create read latest archive show prune help" -f -a "create" -d 'Create a new spec file'
complete -c ck -n "__fish_ck_using_subcommand s; and not __fish_seen_subcommand_from list create read latest archive show prune help" -f -a "read" -d 'Read spec file body or frontmatter'
complete -c ck -n "__fish_ck_using_subcommand s; and not __fish_seen_subcommand_from list create read latest archive show prune help" -f -a "latest" -d 'Find most recently modified spec file'
complete -c ck -n "__fish_ck_using_subcommand s; and not __fish_seen_subcommand_from list create read latest archive show prune help" -f -a "archive" -d 'Move a spec file to archive/ subfolder'
complete -c ck -n "__fish_ck_using_subcommand s; and not __fish_seen_subcommand_from list create read latest archive show prune help" -f -a "show" -d 'Show spec content by ID'
complete -c ck -n "__fish_ck_using_subcommand s; and not __fish_seen_subcommand_from list create read latest archive show prune help" -f -a "prune" -d 'Archive spec files older than N days'
complete -c ck -n "__fish_ck_using_subcommand s; and not __fish_seen_subcommand_from list create read latest archive show prune help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
complete -c ck -n "__fish_ck_using_subcommand s; and __fish_seen_subcommand_from list" -s p -l project -d 'Filter by project path' -r
complete -c ck -n "__fish_ck_using_subcommand s; and __fish_seen_subcommand_from list" -l json -d 'Output as JSON'
complete -c ck -n "__fish_ck_using_subcommand s; and __fish_seen_subcommand_from list" -l all -d 'Show specs from all projects'
complete -c ck -n "__fish_ck_using_subcommand s; and __fish_seen_subcommand_from list" -l archived -d 'Show archived specs instead of active'
complete -c ck -n "__fish_ck_using_subcommand s; and __fish_seen_subcommand_from list" -s h -l help -d 'Print help'
complete -c ck -n "__fish_ck_using_subcommand s; and __fish_seen_subcommand_from create" -l topic -d 'Spec topic' -r
complete -c ck -n "__fish_ck_using_subcommand s; and __fish_seen_subcommand_from create" -l project -d 'Project path' -r
complete -c ck -n "__fish_ck_using_subcommand s; and __fish_seen_subcommand_from create" -l slug -d 'Custom slug (auto-generated if omitted)' -r
complete -c ck -n "__fish_ck_using_subcommand s; and __fish_seen_subcommand_from create" -l prefix -d 'Filename prefix' -r
complete -c ck -n "__fish_ck_using_subcommand s; and __fish_seen_subcommand_from create" -l body -d 'Spec body content' -r
complete -c ck -n "__fish_ck_using_subcommand s; and __fish_seen_subcommand_from create" -s h -l help -d 'Print help'
complete -c ck -n "__fish_ck_using_subcommand s; and __fish_seen_subcommand_from read" -l frontmatter -d 'Output frontmatter as JSON'
complete -c ck -n "__fish_ck_using_subcommand s; and __fish_seen_subcommand_from read" -s h -l help -d 'Print help'
complete -c ck -n "__fish_ck_using_subcommand s; and __fish_seen_subcommand_from latest" -l project -d 'Project path (defaults to git root or cwd)' -r
complete -c ck -n "__fish_ck_using_subcommand s; and __fish_seen_subcommand_from latest" -l task-file -d 'Resolve this file directly instead of mtime heuristic' -r
complete -c ck -n "__fish_ck_using_subcommand s; and __fish_seen_subcommand_from latest" -s h -l help -d 'Print help'
complete -c ck -n "__fish_ck_using_subcommand s; and __fish_seen_subcommand_from archive" -s h -l help -d 'Print help'
complete -c ck -n "__fish_ck_using_subcommand s; and __fish_seen_subcommand_from show" -s h -l help -d 'Print help'
complete -c ck -n "__fish_ck_using_subcommand s; and __fish_seen_subcommand_from prune" -l days -d 'Age threshold in days' -r
complete -c ck -n "__fish_ck_using_subcommand s; and __fish_seen_subcommand_from prune" -s p -l project -d 'Filter by project path' -r
complete -c ck -n "__fish_ck_using_subcommand s; and __fish_seen_subcommand_from prune" -l dry-run -d 'Dry run — print what would be archived'
complete -c ck -n "__fish_ck_using_subcommand s; and __fish_seen_subcommand_from prune" -s h -l help -d 'Print help'
complete -c ck -n "__fish_ck_using_subcommand s; and __fish_seen_subcommand_from help" -f -a "list" -d 'List specs for the current project'
complete -c ck -n "__fish_ck_using_subcommand s; and __fish_seen_subcommand_from help" -f -a "create" -d 'Create a new spec file'
complete -c ck -n "__fish_ck_using_subcommand s; and __fish_seen_subcommand_from help" -f -a "read" -d 'Read spec file body or frontmatter'
complete -c ck -n "__fish_ck_using_subcommand s; and __fish_seen_subcommand_from help" -f -a "latest" -d 'Find most recently modified spec file'
complete -c ck -n "__fish_ck_using_subcommand s; and __fish_seen_subcommand_from help" -f -a "archive" -d 'Move a spec file to archive/ subfolder'
complete -c ck -n "__fish_ck_using_subcommand s; and __fish_seen_subcommand_from help" -f -a "show" -d 'Show spec content by ID'
complete -c ck -n "__fish_ck_using_subcommand s; and __fish_seen_subcommand_from help" -f -a "prune" -d 'Archive spec files older than N days'
complete -c ck -n "__fish_ck_using_subcommand s; and __fish_seen_subcommand_from help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c ck -n "__fish_ck_using_subcommand notify" -s h -l help -d 'Print help'
complete -c ck -n "__fish_ck_using_subcommand n" -s h -l help -d 'Print help'
complete -c ck -n "__fish_ck_using_subcommand tool; and not __fish_seen_subcommand_from slug phases completion gitcontext compaction-recovery cochanges help" -s h -l help -d 'Print help'
complete -c ck -n "__fish_ck_using_subcommand tool; and not __fish_seen_subcommand_from slug phases completion gitcontext compaction-recovery cochanges help" -f -a "slug" -d 'Generate URL-safe slug from text'
complete -c ck -n "__fish_ck_using_subcommand tool; and not __fish_seen_subcommand_from slug phases completion gitcontext compaction-recovery cochanges help" -f -a "phases" -d 'Parse phase markers from plan file'
complete -c ck -n "__fish_ck_using_subcommand tool; and not __fish_seen_subcommand_from slug phases completion gitcontext compaction-recovery cochanges help" -f -a "completion" -d 'Generate shell completion scripts'
complete -c ck -n "__fish_ck_using_subcommand tool; and not __fish_seen_subcommand_from slug phases completion gitcontext compaction-recovery cochanges help" -f -a "gitcontext" -d 'Gather branch context (diff, log, files) for skills'
complete -c ck -n "__fish_ck_using_subcommand tool; and not __fish_seen_subcommand_from slug phases completion gitcontext compaction-recovery cochanges help" -f -a "compaction-recovery" -d 'Emit compaction-recovery context for SessionStart hooks'
complete -c ck -n "__fish_ck_using_subcommand tool; and not __fish_seen_subcommand_from slug phases completion gitcontext compaction-recovery cochanges help" -f -a "cochanges" -d 'Find files frequently changed together with current changes'
complete -c ck -n "__fish_ck_using_subcommand tool; and not __fish_seen_subcommand_from slug phases completion gitcontext compaction-recovery cochanges help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c ck -n "__fish_ck_using_subcommand tool; and __fish_seen_subcommand_from gitcontext" -l stat -d 'Output diff --stat instead of full diff'
complete -c ck -n "__fish_ck_using_subcommand tool; and __fish_seen_subcommand_from gitcontext" -l cochanges -d 'Include co-change candidates in output'
complete -c ck -n "__fish_ck_using_subcommand tool; and __fish_seen_subcommand_from gitcontext" -s h -l help -d 'Print help'
complete -c ck -n "__fish_ck_using_subcommand tool; and __fish_seen_subcommand_from compaction-recovery" -s h -l help -d 'Print help'
...
complete -c ck -n "__fish_ck_using_subcommand tool; and __fish_seen_subcommand_from help" -f -a "compaction-recovery" -d 'Emit compaction-recovery context for SessionStart hooks'
...
complete -c ck -n "__fish_ck_using_subcommand o; and not __fish_seen_subcommand_from slug phases completion gitcontext compaction-recovery cochanges help" -s h -l help -d 'Print help'
complete -c ck -n "__fish_ck_using_subcommand o; and not __fish_seen_subcommand_from slug phases completion gitcontext compaction-recovery cochanges help" -f -a "slug" -d 'Generate URL-safe slug from text'
complete -c ck -n "__fish_ck_using_subcommand o; and not __fish_seen_subcommand_from slug phases completion gitcontext compaction-recovery cochanges help" -f -a "phases" -d 'Parse phase markers from plan file'
complete -c ck -n "__fish_ck_using_subcommand o; and not __fish_seen_subcommand_from slug phases completion gitcontext compaction-recovery cochanges help" -f -a "completion" -d 'Generate shell completion scripts'
complete -c ck -n "__fish_ck_using_subcommand o; and not __fish_seen_subcommand_from slug phases completion gitcontext compaction-recovery cochanges help" -f -a "gitcontext" -d 'Gather branch context (diff, log, files) for skills'
complete -c ck -n "__fish_ck_using_subcommand o; and not __fish_seen_subcommand_from slug phases completion gitcontext compaction-recovery cochanges help" -f -a "compaction-recovery" -d 'Emit compaction-recovery context for SessionStart hooks'
complete -c ck -n "__fish_ck_using_subcommand o; and not __fish_seen_subcommand_from slug phases completion gitcontext compaction-recovery cochanges help" -f -a "cochanges" -d 'Find files frequently changed together with current changes'
complete -c ck -n "__fish_ck_using_subcommand o; and not __fish_seen_subcommand_from slug phases completion gitcontext compaction-recovery cochanges help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c ck -n "__fish_ck_using_subcommand o; and __fish_seen_subcommand_from gitcontext" -l stat -d 'Output diff --stat instead of full diff'
complete -c ck -n "__fish_ck_using_subcommand o; and __fish_seen_subcommand_from gitcontext" -l cochanges -d 'Include co-change candidates in output'
complete -c ck -n "__fish_ck_using_subcommand o; and __fish_seen_subcommand_from gitcontext" -s h -l help -d 'Print help'
complete -c ck -n "__fish_ck_using_subcommand o; and __fish_seen_subcommand_from compaction-recovery" -s h -l help -d 'Print help'
...
complete -c ck -n "__fish_ck_using_subcommand o; and __fish_seen_subcommand_from help" -f -a "compaction-recovery" -d 'Emit compaction-recovery context for SessionStart hooks'
...
complete -c ck -n "__fish_ck_using_subcommand help; and not __fish_seen_subcommand_from tui task plan spec project notify tool help" -f -a "tui" -d 'Launch the interactive TUI'
complete -c ck -n "__fish_ck_using_subcommand help; and not __fish_seen_subcommand_from tui task plan spec project notify tool help" -f -a "task" -d 'Task operations'
complete -c ck -n "__fish_ck_using_subcommand help; and not __fish_seen_subcommand_from tui task plan spec project notify tool help" -f -a "plan" -d 'Plan file operations'
complete -c ck -n "__fish_ck_using_subcommand help; and not __fish_seen_subcommand_from tui task plan spec project notify tool help" -f -a "spec" -d 'Spec file operations'
complete -c ck -n "__fish_ck_using_subcommand help; and not __fish_seen_subcommand_from tui task plan spec project notify tool help" -f -a "project" -d 'Project operations'
complete -c ck -n "__fish_ck_using_subcommand help; and not __fish_seen_subcommand_from tui task plan spec project notify tool help" -f -a "notify" -d 'Handle notification hooks'
complete -c ck -n "__fish_ck_using_subcommand help; and not __fish_seen_subcommand_from tui task plan spec project notify tool help" -f -a "tool" -d 'Utility tools'
complete -c ck -n "__fish_ck_using_subcommand help; and not __fish_seen_subcommand_from tui task plan spec project notify tool help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c ck -n "__fish_ck_using_subcommand help; and __fish_seen_subcommand_from plan" -f -a "prune" -d 'Archive plan files older than N days'
complete -c ck -n "__fish_ck_using_subcommand help; and __fish_seen_subcommand_from spec" -f -a "list" -d 'List specs for the current project'
complete -c ck -n "__fish_ck_using_subcommand help; and __fish_seen_subcommand_from spec" -f -a "create" -d 'Create a new spec file'
complete -c ck -n "__fish_ck_using_subcommand help; and __fish_seen_subcommand_from spec" -f -a "read" -d 'Read spec file body or frontmatter'
complete -c ck -n "__fish_ck_using_subcommand help; and __fish_seen_subcommand_from spec" -f -a "latest" -d 'Find most recently modified spec file'
complete -c ck -n "__fish_ck_using_subcommand help; and __fish_seen_subcommand_from spec" -f -a "archive" -d 'Move a spec file to archive/ subfolder'
complete -c ck -n "__fish_ck_using_subcommand help; and __fish_seen_subcommand_from spec" -f -a "show" -d 'Show spec content by ID'
complete -c ck -n "__fish_ck_using_subcommand help; and __fish_seen_subcommand_from spec" -f -a "prune" -d 'Archive spec files older than N days'
...
complete -c ck -n "__fish_ck_using_subcommand help; and __fish_seen_subcommand_from tool" -f -a "compaction-recovery" -d 'Emit compaction-recovery context for SessionStart hooks'
